...
package net.akehurst.kaf.technology.persistence.fs.hjson

import PersistentStoreFilesystemHJson
...
class test_PersistentStoreFilesystemHJson_AddressBook : Application {
    ...
    companion object {
        val KOMPOSITE = """
            ...
            namespace net.akehurst.kaf.technology.persistence.fs.hjson {
    ...
    val sut = PersistentStoreFilesystemHJson("sut")
